...
public class AppointmentPage extends BasePage {
    ...
    public void selectFacility(String facility) {
        Select select =
                new Select(driver.findElement(facilityDropdown));
    ...
    public void clickBookAppointment() {
        ...
        driver.findElement(bookAppointmentBtn)
                .click();
    }

    // Complete Appointment Booking
    public void bookAppointment(String facility,
                                String date,
                                String comment) {
    ...
    public void bookAppointmentWithAdmission(String facility,
                                             String date,
                                             String comment) {
